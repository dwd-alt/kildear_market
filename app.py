...
class Config:
    ...
    SQLALCHEMY_DATABASE_URI = os.environ.get('DATABASE_URL') or 'postgresql://killedar_usera:3UEAF8KtPMCnvHUe9NAYpgHSGtV2pEwo@dpd-d6ncpsa4d56v73dev6tg-a.singapore-postgres.render.com:5432/killedar_mar'
    ...
    MAIL_PORT = 587
    MAIL_USE_TLS = True
    MAIL_USERNAME = os.environ.get('MAIL_USERNAME') or 'iewlewroman84@gmail.com'
    MAIL_PASSWORD = os.environ.get('MAIL_PASSWORD') or ''  # Пароль приложения Gmail
...
def cart():
    ...
    pvz_points = PVZPoint.query.filter_by(is_active=True).all()
    
    return render_template('cart.html', cart_items=cart_items, total=total, pvz_points=pvz_points)
...
def init_db():
    ...
    with app.app_context():
        ...
        print("✅ Создан тестовый администратор: admin@kildear.com / Admin123!")
